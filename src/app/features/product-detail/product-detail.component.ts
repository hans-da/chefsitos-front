            ...
            <div class="lg:col-span-5 flex flex-col pt-4">
              <div class="mb-10">
                <div class="flex items-center gap-3 mb-6">
                  ...
                  <app-badge [text]="product()?.disponible ? 'Disponible' : 'No Disponible'" [type]="product()?.disponible ? 'success' : 'neutral'"></app-badge>
                </div>
              ...
              <div class="mt-12 flex items-center gap-4 py-6 border-t border-gray-50">
                ...
                <p class="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Calidad garantizada por <span class="text-indigo-300 italic">Chefsitos</span></p>
              </div>
            </div>
          </div>
        }
